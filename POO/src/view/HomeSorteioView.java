...
import vo.AlunoVO;
import vo.EventoVO;
import java.util.Random; // para sorteio

/**
 *
 * @author cesarvergara
 */
public class HomeSorteioView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonSorteio.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        buttonSorteio.setForeground(new java.awt.Color(255, 179, 0));
        buttonSorteio.setText("REALIZAR SORTEIO");
        buttonSorteio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                buttonSorteioMouseClicked(evt);
            }
        });
    ...
    }//GEN-LAST:event_buttonSorteioMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomeSorteioView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomeSorteioView().setVisible(true);
            }
        });
    }
